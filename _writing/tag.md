...
Maybe I shouldn't have told you about [Fortress](/fortress/). I thought that it'd be a good starting point, to tell about differences between the most prominent sports, to tell about something that would be straightforwardly technically feasible to implement on Earth as well. Given the restrictions in, uh, social technology, it in fact doesn't seem likely that we can play it anytime soon here. (And I no doubt misremember some details -- it's been a while since I last got to play it.)
