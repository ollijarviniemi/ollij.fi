...
But shortly before that I had (perhaps thinking of multi-hour walks) ended up reading the Wikipedia page on [ultralight backpacking](https://en.wikipedia.org/wiki/Ultralight_backpacking). And in light of that, the idea of a phoneless hiker started to look less absurd.
...
([Except.](https://arxiv.org/pdf/2602.05910))
