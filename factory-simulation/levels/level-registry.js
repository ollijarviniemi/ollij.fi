/**
 * Level Registry for Bayesian Factory: Simulation
 *
...
const LevelRegistry = {
  GAME_NAME: 'factory-simulation',

  // Only the first 5 groups are shown in the player UI (index.html iterates GROUP_NAMES).
  // group6/group7/other still hold levels in storage but aren't surfaced.
  GROUP_NAMES: ['Mixer', 'Loops', 'Distribution', 'Multiple balls', 'Duplicator', 'Switch', 'Other'],

  GROUP_DESCRIPTIONS: [
    'Levels with only mixers.',
    'Conveyor belts and mixers form loops.',
    'Each box has its own probability.',
    'Several balls travel through the factory.',
    'Levels where balls are duplicated.',
    null, null
  ],
