...
const SackSpec = {
  ...
  behavior: {
     ...
     */
    draw(rng, params) {
      console.log('[SACK DRAW] Called with params:', JSON.stringify(params));
      ...
      const result = rng.weightedChoice(colors, weights);
      console.log('[SACK DRAW] Returning color:', result);
      return result;
    }
  },
