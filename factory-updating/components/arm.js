...
const ArmSpec = {
  ...
  pivotRadius: 0.15,      // Radius of center pivot circle
  grabberRadius: 0.1,   // Radius of grabber circle at end
  centerOffset: 0.2,      // How much to offset pivot toward sack (0 = cell center, 0.5 = at edge)
  ...
  visual: {
    ...
    render(ctx, component, time) {
      ...
      const spec = ComponentRegistry.get('arm');
      const armLength = spec.armLength * gridSize;
      const pivotRadius = spec.pivotRadius * gridSize;
      const grabberRadius = spec.grabberRadius * gridSize;
      ...
      // Draw center pivot circle (filled)
      ctx.fillStyle = "#666";
      ctx.strokeStyle = "#000";
      ctx.beginPath();
